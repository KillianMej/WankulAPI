    ...
    const exempleJsonRarete = `[
  {
    ...
    return(
        <section>
            ...
            <p>Pour faire un appel à l'API, utilisez <span className="requete">https://api.wankulapi-unofficial.fr</span></p>            <p>Elle renvoie les informations demandées sous forme de JSON</p>
